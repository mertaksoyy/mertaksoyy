...
- 🚀 I use daily ```Flutter```, ```C#``` and ```.Python```
...
<p><b>:mailbox: Contact Me:<b><a href="mailto:mrtaksy99@gmail.com"> mrtaksy99@gmail.com<a><p>
  ...
  <img src="https://skillicons.dev/icons?i=py,sqlite,cs,cpp,flutter,kotlin,dotnet,firebase,androidstudio,vscode,visualstudio">
